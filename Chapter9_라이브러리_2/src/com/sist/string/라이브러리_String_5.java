...
public class 라이브러리_String_5 {
	...
	public static void main(String[] args) {
		...
		// 라이브러리 공부할 때 => 1) 기능 2) 리턴형 3) 매개변수 4) 사용처 =? 로그인, 상세보기
		...
		// 원형 : boolean equalsIsIgnoreCase(String s)
		...
		String ss="http://localhost:8080/JSPProject/main/mian.do";
		String res=ss.substring(ss.lastIndexOf("/")+1);
		
		System.out.println(res);
		res=ss.substring(1,ss.indexOf("//")+2);
