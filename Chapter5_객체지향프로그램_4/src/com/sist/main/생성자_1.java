 ...
 * 						=> b.age
 * 						=> b.name
 * 					==============> class는 한개만 설계 ==> 저장을 new 이용해서 여러개
 * 					
 ...
 * 		   => 공유변수 : 오라클
 * 			형식) [접근지정어] static 데이터형 변수명 = 값(디폴트 값)
 * 				 int => 0
 * 				 double => 0.0
 * 				 boolean => false
 ...
 * 				(int[] arr)
 * 				회원가입
 * 				(String id, String pwd, String name, String sex, int age, String post, String addr1,
