...
/*
 *	335page => Collection => 데이터를 묶어서 관리할 수 있게 만든 클래스
 *				=> 배열의 단점 보완
 *	컬렉션 프레임워크 (프레임워크 => 표준화)
 *		---------> 모든 개발자가 동일한 형태로 소스코딩
 *					소스의 통일화 목적 : Spring, MyBatis, JQuery
 *									VueJS, ReactJS
 *					일정 툴 => 쉽게 다른 개발자의 코딩을 분석
 *		= 완전 통일화 : 라이브러리
...
public class 라이브러리_List_1 {
	...
	public static void main(String[] args) {
		...
		list.add("심청이"); // index=2 =>3 (2)
		list.add("춘향이"); // index=3 =>4 (3)
		list.add("이순신"); // index=4 =>5로 변경(4)
		list.add(2, "강감찬"); // index=2; => 중간 삽입(1)
		list.add(3, "을지문덕"); // index=3; 동일과정반복
		...
		// 맨마지막에 추가 => 속도가 늦다 // 데이터를 다 바꿔야하기 떄문에
