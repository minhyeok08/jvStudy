...
public class 문자열_5 {
	...
	public static void main(String[] args) {
		...
		/*for(String s:music)
		{
			if(s.length()>37)
			{
				String ss = s.substring(0,34)+"..."; // 34글자넘으면 나머지부분 ...으로 출력
		...
		String s = addr.substring(0,addr.lastIndexOf("지번")); //*** 지번의 위치값 앞까지 출력
		System.out.println(s);
		/*
		 * 	인덱스가 있는 위치값 
		 *  lastIndexOf() 뒤에서부터 찾기 (뒤의 a찾기)
		 *  indexOf() 앞에서부터 찾기 (앞의 a찾기)
