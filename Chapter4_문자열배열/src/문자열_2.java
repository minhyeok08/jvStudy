	...
	public static void main(String[] args) {
		...
		while(true)
		{
			...
			if(menu==1)
			{
				...
				{
					System.out.println((i+1)+"."+title[i]+" ["+singer[i]+"]"); //for each문 안됨(?)
				}
			}
			if(menu==2)
			{
