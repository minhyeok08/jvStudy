 ...
 * 		----------------------
 * 		멤버변수
 * 		= 인스턴스 변수 => new를 사용할떄마다 메모리가 따로 생성
 * 		= 정적 변수 (공유 변수) => 메모리가 한개만 생성
 * 		----------------------
 ...
 *					--- (리턴값보다 클수도 있다) double, float, long => int 권장
 *					{
 *						// 구현부
 *						int c = a + b;
 *						
 ...
 * 					 |	 |
 * 					 a	 b ==> int c = 30
 * 		boolean idLogin(String id, String pwd)
 * 		{
 * 			return true;
 * 		}
 * 		
...
public class 클래스구성요소 {
	...
	public static void main(String[] args) {
		...
		System.out.println("물리:"+hi);
		System.out.println("국사:"+phy);
		// 총점 계산
